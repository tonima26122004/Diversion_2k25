...
const Hot = () => {
  ...
  const fetchNews = async () => {
    ...
    try {
      const res = await fetch(
        `https://newsapi.org/v2/everything?q=${selectedCategory}&sortBy=publishedAt&apiKey=52c8562a09804547856d91128eee3af1`
      );
  ...
  // Fetch news when component mounts & when category changes
  useEffect(() => {
    fetchNews();
          ...
          <div className="sticky top-0 z-10 bg-[#E4E2D6]">
            ...
            <div className="flex justify-between items-center py-2 px-4">
              <div className="flex flex-col w-full gap-2">
                <h1 className="text-5xl font-libra text-[#000000]">Latest News Updates</h1>
                <h1 className="text-xl font-libra text-[#52524D]">Stay Informed on the Latest Headlines</h1>
            ...
            <div className="w-[25%] pl-6">
              <div className="mb-2">
                <span className="text-xl font-libra text-black">Search <span className="text-red-900">News</span> by <span className="text-red-900">Category</span></span>
              </div>
              ...
              <div className="flex items-center justify-between border border-black rounded-full p-1 pl-2">
                ...
                {/* Search Button */}
                <button className="bg-black text-white w-10 h-10 flex items-center justify-center rounded-full hover:bg-gray-800" onClick={fetchNews} disabled={loading}>
