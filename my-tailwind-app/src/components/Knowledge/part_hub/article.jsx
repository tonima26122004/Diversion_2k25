  ...
  return (
    <div className="relative flex flex-col items-center font-libra p-6 rounded-lg max-w-xs mx-auto">
      ...
      <div className="flex flex-col space-y-2 w-full items-center">
        <a href={"/Read_the_article"} className="bg-black text-white text-md font-medium py-1 px-2 rounded-full text-center transition-all duration-300 hover:bg-gray-800 inline-block">
