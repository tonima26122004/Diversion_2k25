    ...
    <div className='overflow-y-auto px-4'> 
      <div className='flex flex-col'>
        ...
        <div className='font-libra text-3xl mt-3 text-[#766C40] flex gap-2'>
            <h1>1. Berubari Union Case</h1><span className='text-black text-2xl'>(</span><span className='text-[#65090A] text-2xl'>1960</span><span className='text-2xl text-black'>)</span>
        </div>
