...
const Nav = () => {
  ...
  return (
    <div className="w-[11%] h-[95%] flex flex-col items-center gap-10 relative">
      {/* Focus box with animation */}
      <div
        className="absolute w-36 h-36 rounded-xl bg-[#E4E2D6A3] transition-transform duration-300"
        style={{
      ...
      <div className="home-button-container">
        <button
          className={`relative z-10 w-32 h-32 flex flex-col justify-center items-center rounded-xl transition-all duration-300 ${
            activeButton === 0 ? 'p-2' : 'hover:p-2'
          }`}
          onClick={() => handleButtonClick(0, '/')}
        >
          <img className="w-24" src="logo_1.svg" alt="Home" />
      ...
      <div className="hub-button-container">
        ...
        >
          <img className="w-24" src="hub.svg" alt="Knowledge Hub" />
          <h1
      ...
      <div className="bot-button-container">
        ...
        >
          <img className="w-24" src="bot.svg" alt="Legal Aid Bot" />
          <h1
            className={`transition-colors duration-300 ${
      ...
      <div className="quiz-button-container">
        ...
        >
          <img className="w-24" src="Mega_quiz.svg" alt="Mega Quiz" />
          <h1
            className={`transition-colors duration-300 ${
      ...
      <div className="news-button-container">
        ...
        >
          <img className="w-20" src="Hot_news.svg" alt="Hot News" />
          <h1
            className={`transition-colors duration-300 ${
