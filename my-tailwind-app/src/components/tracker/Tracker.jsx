...
const Tracker = () => {
  ...
  <div className="bg-[#766C40] h-screen w-screen flex items-center justify-between relative">
    ...
    <div className="bg-[#E4E2D6] w-[88%] h-[95%] rounded-xl mr-4 relative overflow-hidden">
      ...
      <h1 className="text-2xl px-4 font-libra font-semibold text-[#766C40] ">Enter place to view  <a className="text-2xl font-libra text-[#65090A]" >law violation data</a>  near you:</h1>

      <div className='flex items-center'>
        <div className=''><Tracker_nav/></div>
